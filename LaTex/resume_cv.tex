...
\name{Akanksha}{Bhardwaj}
\address{Girls Hostel – 2 ,
Indian Institute of Information Technology, Allahabad campus ,
Allahabad , Uttar Pradesh , India}
\mobile{(+91) 8447706195}

\email{sashafierce639@gmail.com}
\homepage{www.akankshabhardwaj.me}
\github{sashafierce}
\linkedin{akanksha-bhardwaj}
%\skype{skypeid}
%\stackoverflow{SOid}{SOname}
%\twitter{@twit}

%\position{Future Software Engineer{\enskip\cdotp\enskip}Learner} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Akanksha Bhardwaj~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
